...
codalab/public_nouns.zip:
	zip -j codalab/public_nouns.zip dataset/public/nouns_public_synsets_parents.tsv

codalab/public_verbs.zip:
	zip -j codalab/public_verbs.zip dataset/public/verbs_public_synsets_parents.tsv

codalab/private_nouns.zip:
	zip -j codalab/private_nouns.zip dataset/private/nouns_private_synsets_parents.tsv

codalab/private_verbs.zip:
	zip -j codalab/private_verbs.zip dataset/private/verbs_private_synsets_parents.tsv
